                        ...
                        <div className="space-y-4 mt-10 ">
                            {[
                                ...
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        `flex items-center  ${isCollapsed ? ' gap-0' : " gap-3"} p-2 text-amber-50 rounded cursor-pointer transition-all duration-300
     ${isActive ? 'bg-amber-900 ' : 'text-amber-50 hover:bg-amber-900 '}`
                                    }
                                >
                    ...
                    <div className="space-y-4 mt-10">
                        <div onClick={() => { dispatch(logout()) }} className={`flex items-center  gap-3 p-2 rounded cursor-pointer transition-all duration-300 text-amber-50 hover:bg-amber-900  `} >
            ...
            <div className="flex-1 flex  flex-col bg-red-100 ">
                <nav className="p-4 flex justify-between gap-4 items-center ">
                    <div className="border border-gray-600   rounded-lg px-3 py-3 flex justify-center items-center" onClick={() => { setIsCollapsed(!isCollapsed) }}>
                        <i class="fa-solid fa-bars text-2xl" ></i>
                    </div>
                    <div className='flex justify-between gap-4 items-center'>
                        <div class="flex items-center gap-2 2xsm:gap-3">
                            <button class="relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-dark-900 h-11 w-11 hover:bg-gray-100 hover:text-gray-700 ">
                            ...
                            <div class="relative">
                                <button class="relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full dropdown-toggle hover:text-gray-700 h-11 w-11 hover:bg-gray-100 ">
                                    <span class="absolute right-0 top-0.5 z-10 h-2 w-2 rounded-full bg-orange-400 hidden">
                        ...
                        <button style={{ width: "fit-content" }} className="flex items-center gap-1 p-2 border bg-white rounded">
                            Admin  <i class="fa-solid fa-down-long  "></i></button>
                    </div>
                </nav>
